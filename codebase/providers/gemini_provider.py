...
class GeminiProvider:
    ...
    def __init__(
        ...
        *,
        ...
        import os
        self.default_model = default_model or os.getenv("LLM_MODEL") or "gemini-3.5-flash"
        ...
        for attempt in range(4):
            try:
                ...
                if "429" in err_str or "RESOURCE_EXHAUSTED" in err_str or "rate limit" in err_str.lower():
                    ...
                    try:
                        print(f"\n[WARNING] Hết hạn ngạch (429/Resource Exhausted). Đang tự động thử lại sau {wait_time}s... (Lượt {attempt+1}/4)", file=sys.stderr)
                    except Exception:
                        pass
            ...
            raise RuntimeError("Hết lượt thử lại sau lỗi giới hạn ngạch 429.")
